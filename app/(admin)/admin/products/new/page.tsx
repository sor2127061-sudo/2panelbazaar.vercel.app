    ...
    <div className="max-w-2xl">
      ...
      <form action={createProduct} className="space-y-6 bg-gray-900 p-6 rounded-lg border border-gray-800">
        <div>
          ...
          <input name="name" required className="w-full p-2 bg-gray-800 rounded border border-gray-700" />
        </div>
        
        <div>
          <label className="block mb-2 text-sm text-gray-400">Description</label>
          <textarea name="description" rows={4} className="w-full p-2 bg-gray-800 rounded border border-gray-700" />
        </div>

        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block mb-2 text-sm text-gray-400">Type</label>
            <select name="product_type" className="w-full p-2 bg-gray-800 rounded border border-gray-700">
          ...
          <div>
            ...
            <select name="category" className="w-full p-2 bg-gray-800 rounded border border-gray-700">
        ...
        <div>
          ...
          <select name="stock_behavior" className="w-full p-2 bg-gray-800 rounded border border-gray-700">
        ...
        <button className="px-6 py-2 bg-primary text-white rounded">Create Product</button>
      </form>
    </div>
  )
}