      ...
      <div className="p-8 bg-gray-900 border border-gray-800 rounded-lg">
        ...
        <form action={handleTopup} className="space-y-4">
          <div>
            ...
            <input name="amount" type="number" min="10" required className="w-full p-3 rounded bg-gray-800 border border-gray-700 text-white" />
          </div>
          <button type="submit" className="w-full py-3 bg-[#0070f3] text-white rounded hover:bg-blue-600 font-medium">Pay with bKash / Nagad</button>
        </form>
      </div>
    </div>
  )
