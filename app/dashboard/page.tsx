  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <header className="flex justify-between items-center py-6 mb-8 border-b border-gray-800">
        ...
        <form action={async () => { 'use server'; const s = createClient(); await s.auth.signOut(); redirect('/login') }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="p-6 bg-gray-900 border border-gray-800 rounded-lg">
          ...
          <div className="mt-4 space-x-4">
            <Link href="/orders" className="text-[#0070f3] hover:underline">Orders</Link>
            <Link href="/my-keys" className="text-[#0070f3] hover:underline">Keys</Link>
            <Link href="/transactions" className="text-[#0070f3] hover:underline">Transactions</Link>
          </div>
        </div>
      </div>
    </div>
